...
\begin{document}
    ...
    \begin{itemize}[label={}]
        ...
        \begin{itemize}[topsep=0pt]\tightlist
            ...
            \item Implemented 80,000 frame-per-second video capture system
            \item Developed bare-metal controller firmware for DMA and Ethernet hardware
            \item Modified Ethernet driver to support 4-port client board
            \item Maintained embedded Linux systems and applications on smart camera hardware
            \item Assisted integrating FPGAs onto custom client circuit boards
            \item Implemented OpenVX image processing functions on FPGA hardware
        \end{itemize}
